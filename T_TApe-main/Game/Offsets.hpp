    ...
    public:
        ...
        ulong inAttack = 0x07872c50; //[Buttons] in_attack=0x07872c50
     
        ulong level = 0x163a9b0;//Miscellaneous LevelName=0x163a9b0
     
        ulong localPlayer = 0x020c20f0 + 0x8; //0x1388eb8 //.?AVC_GameMovement@@=0x020c20f0
     
        ulong entityList = 0x1d10e18; //cl_entitylist=0x1d10e18
     
        ulong viewRender = 0x7870390; //[Miscellaneous] ViewRender=0x7870390
